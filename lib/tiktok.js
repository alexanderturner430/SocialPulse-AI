...
async function generateCaption(topic, style = "engaging") {
  try {
    ...
    const promptText = `Generate 5 TikTok captions for: "${topic}". Style: ${style}. Include relevant emojis and hashtags. Format as JSON array.`;
    const response = await askLLM(promptText, "You are a TikTok content expert. Create viral captions.");
